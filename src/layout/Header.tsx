import { alpha, AppBar, Avatar, Box, InputAdornment, InputBase, TextField, Typography } from '@mui/material'
...
const Header = () => {
  return (
  <Box sx={{width:"100%",height:"40px", display:"flex", flexDirection:"row", justifyContent:"space-between",overflowY:"hidden"}}>
